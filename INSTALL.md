# Установка Cyrius Stream Control v5.10.0
...
Ожидаемая версия: `5.10.0`. Панель: `http://IP_СЕРВЕРА:8088/?v=510`.
...
Архив должен находиться в `/root/flussonic-panel-v5.10.zip`.

```bash
rm -rf /tmp/flussonic-panel-v510
mkdir -p /tmp/flussonic-panel-v510
unzip -q -o /root/flussonic-panel-v5.10.zip -d /tmp/flussonic-panel-v510
...
cp -a /tmp/flussonic-panel-v510/flussonic-panel/. /root/flussonic-panel/
...
Образ должен быть `flussonic-panel:v510`.
